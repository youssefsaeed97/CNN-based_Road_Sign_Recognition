...
def load_data(data_dir):
    ...
    for entry in entries:
        path1 = os.path.join(data_dir, entry)
        signs = os.listdir(path1)

        for sign in signs:
            path2 = os.path.join(data_dir, entry, sign)
...
def get_model():
    ...
    # First convolutional layer. Learn 50 filters using a 3x3 kernel
    ...
    # Second convolutional layer. Learn 30 filters using a 3x3 kernel
    tf.keras.layers.Conv2D(
